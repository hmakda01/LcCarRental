...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnDisplayAll" runat="server" style="z-index: 1; left: 277px; top: 367px; position: absolute; height: 26px; width: 100px" Text="Display All" OnClick="btnDisplayAll_Click" />
        <p>
            &nbsp;</p>
